<x-app-layout>
    ...
    <section class="w-screen h-full flex justify-evenly flex-wrap gap-12 lg:flex-nowrap lg:gap-0 lg:h-panel items-center bg-gradient-to-r from-color_1 via-color_2 to-color_3">
