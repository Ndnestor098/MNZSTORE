...
<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
    ...
    <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
        <li><a class="text-sm {{ Route::is('home') ? 'text-blue-600 font-bold' : 'text-gray-400 hover:text-gray-500' }} " href="{{ route('home') }}">Home</a></li>
        ...
        <li><a class="text-sm {{ Route::is('about') ? 'text-blue-600 font-bold' : 'text-gray-400 hover:text-gray-500' }}" href="#">About Us</a></li>
        ...
        <li><a class="text-sm {{ Route::is('services') ? 'text-blue-600 font-bold' : 'text-gray-400 hover:text-gray-500' }}" href="#">Services</a></li>
        ...
        <li><a class="text-sm {{ Route::is('contact') ? 'text-blue-600 font-bold' : 'text-gray-400 hover:text-gray-500' }}" href="#">Contact</a></li>
    </ul>
